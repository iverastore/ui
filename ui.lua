...
return Library 
    ...
    local SubTabTemplate = { }
    
    function SubTabTemplate:New(Page, Name)
        local SubTab = {
            Name = Name,
            Page = Page,
            Tabs = {},
        ...
        Items["Container"] = Library:Create("Frame", {
            Name = "\0",
            Parent = Page.Items["Content"].Instance,
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 0),
            BorderSizePixel = 0,
            AutomaticSize = Enum.AutomaticSize.Y
        ...
        Items["SectionContainer"] = Library:Create("Frame", {
            Name = "\0",
            Parent = Items["Container"].Instance,
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 0),
        ...
        Library:Create("UIListLayout", {
            Name = "\0",
            Parent = Items["SectionContainer"].Instance,
            Padding = UDim.new(0, 0),
            SortOrder = Enum.SortOrder.LayoutOrder
        })
        ...
        function SubTab:Section(Params)
            Params = Params or {}
            ...
            local SideContainer
            if not Items["SideContainer_" .. Params.Side] then
                SideContainer = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Items["SectionContainer"].Instance,
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, 0, 0, 0),
                ...
                Library:Create("UIListLayout", {
                    Name = "\0",
                    Parent = SideContainer.Instance,
                    Padding = UDim.new(0, 8),
                    SortOrder = Enum.SortOrder.LayoutOrder,
                    FillDirection = Enum.FillDirection.Horizontal
                })
                
                Items["SideContainer_" .. Params.Side] = SideContainer
            else
                SideContainer = Items["SideContainer_" .. Params.Side]
            end
            ...
            SectionItems["Section"] = Library:Create("Frame", {
                Name = "\0",
                Parent = SideContainer.Instance,
                Size = UDim2.new(0.5 - 0.004, 0, 0, 0),
                BorderSizePixel = 0,
                BackgroundColor3 = Library.Theme["Background"],
                AutomaticSize = Enum.AutomaticSize.Y
            }):AddToTheme({BackgroundColor3 = 'Background'})
            ...
            if Params.Side == 1 then
                SectionItems["Section"].Instance.LayoutOrder = 1
            else
                SectionItems["Section"].Instance.LayoutOrder = 2
            end
    ...
    function PageMeta:SubTab(Params)
        Params = Params or {}
        local SubTabName = Params.Name or "SubTab"
        
        if not self.SubTabs then
            self.SubTabs = {}
        end
        
        if not self.SubTabs[SubTabName] then
            self.SubTabs[SubTabName] = SubTabTemplate:New(self, SubTabName)
        end
        
        return self.SubTabs[SubTabName]
    end
